...
/**
 * xml读取工具类
 * @method readXMlDocument:解读数据文件，返回一个HashMap对象，包含元素查询的记录信息。支持两种重构方法。
 * @method getByType：枚举方法，确定查询元素的方式，并返回。
 * @method getXmlPageURL:解析XML文件，返回一个URL路径，该路径指向xml参数文件。
 * @method getTestngParametersValue：返回一个string,是从 TESTNG 参数文件中读取的值。
...
public class XmlReadUtil {
	...
	/**
	 * @method 解析XML文件，返回一个URL路径，该路径指向xml参数文件。
	 * @param path
	 * @param pageName
	 * @return
	 */
	...
	/**
	 * 返回一个string,是从 TESTNG 参数文件中读取的值。
	 * @param path
